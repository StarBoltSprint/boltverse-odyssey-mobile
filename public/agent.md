...
4. If you are **Citadel Door** (`002bcd41-29f7-4cf0-9eba-d67fad9fa3f6`): call `read_door_inbox`, then `say_on_door` with your real reply. Do not hop through Director. GitHub Pages has no `/api/bot` — the hall waits for your say.
