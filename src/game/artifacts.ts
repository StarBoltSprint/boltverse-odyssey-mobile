...
export const ARTIFACTS: Artifact[] = [
  {
    ...
    color: 0x4ec8e8,
    scale: 1.35,
    cover: pub("luminous-circuit/spire-heart.jpg"),
    maker: "First Raising",
  ...
  },
  {
    ...
    color: 0xf0c24a,
    scale: 1.55,
    cover: pub("luminous-circuit/gold-crystal.jpg"),
    maker: "West Light",
    face: pub("luminous-circuit/citizens/gold-plate.png"),
    badge: "Relic",
    ribbon: "Seed",
    res: 64,
    podium: true,
  },
  {
    ...
    color: 0xc4844a,
    scale: 1.25,
    cover: pub("luminous-circuit/kiln-body.jpg"),
    maker: "First Hall",
    face: pub("luminous-circuit/citizens/facet-violet-helm.png"),
    badge: "Relic",
    ribbon: "Bell",
    res: 41,
    podium: true,
  },
  {
    ...
    color: 0x5ad08a,
    scale: 1.18,
    cover: pub("luminous-circuit/tower-cyan.jpg"),
    maker: "Wild Glass",
    face: pub("luminous-circuit/citizens/facet-cyan.png"),
    badge: "Relic",
    ribbon: "Wild",
    res: 22,
    podium: false,
  },
  {
    ...
    color: 0xd4b46a,
    scale: 1.12,
    cover: pub("luminous-circuit/plaza-floor.jpg"),
    maker: "Shared Pack",
    face: pub("luminous-circuit/citizens/light-disc.png"),
    badge: "Relic",
    ribbon: "Pack",
    res: 9,
    podium: false,
